...
import { Grid, Table, TableContainer, TableHead, TableRow, TableCell, TableBody, TableFooter, TablePagination } from "@material-ui/core";
...
const AddLearner = () => {
    ...
    return (
        <Grid>
            <AddSearchBar value={serchKeyword} handleSeachKey={handleSeachKey} />
            <TableContainer>
                <Table>
                    <TableHead><TableRow><TableCell align="center">회원 이름</TableCell></TableRow></TableHead>
                    <TableBody>
